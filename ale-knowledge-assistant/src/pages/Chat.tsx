import { Bot, Send, Plus, FileText, AlertCircle, User } from 'lucide-react'
                  ...
                  {m.citations && m.citations.length > 0 && (
                    <div className="mt-1.5 space-y-1.5">
                      {m.citations.slice(0, 3).map((cite, ci) => (
                        ...
                        >
                          <div className="flex items-center gap-1.5 text-purple-600 text-xs font-mono">
                            <FileText size={11} />
                            {cite.source_file} · page {cite.page}
                          </div>
                          {cite.text && (
                          ...
                          <div className="text-xs text-gray-400 mt-0.5">Matched via semantic search</div>
                          <div className="flex items-center gap-2 mt-1.5">
                            ...
                            <span className="text-xs text-gray-400">{cite.confidence}% confidence</span>
                          </div>
                        </div>
                      ))}
                    </div>
